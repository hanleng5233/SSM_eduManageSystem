            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                   <c:if test="${user.usertype==1}">
                    ...
                    <li>
                        <a href="page/homepage/test2.jsp" target="right"><i class="fa fa-desktop "></i>查看课表 </a>
                    </li>
                    ...
                    <li>
                        <a href="page/homepage/test.jsp"  target="right"><i class="fa fa-bar-chart-o"></i>修改密码</a>
                    </li>
                    </c:if>
                    ...
                    <li>
                        <a href="page/homepage/test3.jsp"  target="right"><i class="fa fa-table "></i>成绩查询</a>
                    </li>
                    <li>
